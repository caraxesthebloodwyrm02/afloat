...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${geistSans.variable} font-sans antialiased bg-zinc-50 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100`}>
        <div className="min-h-screen flex flex-col">
          ...
          <footer className="border-t border-zinc-200 dark:border-zinc-800 py-4 px-6 text-center text-xs text-zinc-400 dark:text-zinc-500">
            ...
            <a href="/privacy" className="hover:text-zinc-600 dark:hover:text-zinc-300 underline">
              Privacy Policy
            </a>
          </footer>
        </div>

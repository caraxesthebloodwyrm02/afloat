...
-   [ ] Conduct soft launch
-   [ ] Acquire first 3 users (validation milestone)
...
-   [ ] Verify net ≥ \$22 at end of 90 days
...
-   [ ] Implement consent UI (CM-01, CM-02, CM-03)
...
-   [ ] Implement all data rights endpoints (DR-01 through DR-04)
...
-   [ ] Implement auto-deletion scheduled job
...
-   [ ] Draft and publish privacy policy v1.0
...
-   [ ] Write Incident Response Plan (72-hour breach notification)
-   [ ] Write internal compliance runbook
-   [ ] Pass all compliance test cases (TC-01 through TC-08)
